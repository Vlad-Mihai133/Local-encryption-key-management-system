...
from klm.db.repositories import CryptoOperationRepository
...
def test_crypto_operation_repository_crud(session):
    repo = CryptoOperationRepository(session)
